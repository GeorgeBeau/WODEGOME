...
//let potanswer = prompt("WHICH FIVE LETTER WORD IS THE ANSWER?")
//let gameOver = false

// if (5 == parseInt(potanswer.length) && wordlist.includes(potanswer.toLowerCase())){
//    answer = potanswer.toUpperCase()
//    answerback = answer
...
//    location.reload()
//}
answer = (arrayOfWords[randomIntInRange]).toUpperCase()
answerback = answer
guesses = 0
let gameOver = false
...
var grid2 = document.getElementById("ALPHABET")
...
for (let y = 0; y < 2; y++) {
    ...
    for (let x = 0; x < 13; x++) {
        ...
        td2.textContent = alphabet[alphabetIndex++]
        td2.classList.add("AlphC")
        tr2.appendChild(td2)
    }
...
function LETTER(){
    ...
    if(5 == parseInt(guess.length) && possibleans.includes(guess.toLowerCase())){
        Vguess = guess.toUpperCase()
    ...
    result = new Array(5).fill("grey")
    Vguess2 = Vguess.toUpperCase()
    //guess test 
    while (INITIALchar < 5){

        if(Vguess[INITIALchar] == answer[INITIALchar]){
            result[INITIALchar] = "green"
            answer = answer.slice(0, INITIALchar) + '$' + answer.slice(INITIALchar + 1)
            Vguess = Vguess.slice(0, INITIALchar) + '#' + Vguess.slice(INITIALchar + 1)
            points++
            greenLetter.push(Vguess2[INITIALchar])
            console.log("green loop results:")
            console.log(Vguess)
            console.log(answer)
            console.log(result)
        }
    ...
    console.log("yellow loop results:")
    ...
    while(char < 5){
        ...
        if(Vguess[char] == answer[0]){result[char] = "yellow"
            Vguess =  Vguess.slice(0, char) + '@' + Vguess.slice(char + 1)
            answer =  answer.slice(0, 0) + '-' + answer.slice(0 + 1)
            console.log(Vguess)
            //console.log(answer[0])
            yellowLetter.push(Vguess2[char])
    
        } 
        else if(Vguess[char] == answer[1]){result[char] = "yellow"
            Vguess =  Vguess.slice(0, char) + '@' + Vguess.slice(char + 1)
            answer =  answer.slice(0, 1) + '-' + answer.slice(1 + 1)
            console.log(Vguess)
            yellowLetter.push(Vguess2[char])
            //console.log(answer[1])
        } 
        else if(Vguess[char] == answer[2]){result[char] = "yellow"
            Vguess =  Vguess.slice(0, char) + '@' + Vguess.slice(char + 1)
            answer =  answer.slice(0, 2) + '-' + answer.slice(2 + 1)
            console.log(Vguess)
            yellowLetter.push(Vguess2[char])
            //console.log(answer[2])
        }
        else if(Vguess[char] == answer[3]){result[char] = "yellow"
            Vguess =  Vguess.slice(0, char) + '@' + Vguess.slice(char + 1)
            answer =  answer.slice(0, 3) + '-' + answer.slice(3 + 1)
            console.log(Vguess)
            yellowLetter.push(Vguess2[char])
            //console.log(answer[3])
        }
        else if(Vguess[char] == answer[4]){result[char] = "yellow"
            Vguess =  Vguess.slice(0, char) + '@' + Vguess.slice(char + 1)
            answer =  answer.slice(0, 4) + '-' + answer.slice(4 + 1)
            console.log(Vguess)
            yellowLetter.push(Vguess2[char])
            ...
            greyLetter.push(Vguess2[char])
        }
        console.log(result)
        char++
    }
    
    console.log("GUESS LOGIC COMPLETE")



    var grid = document.getElementById("GUESS1")
    ...
    for ( x = 0 ; x < 5; x++) {
        ...
        td.textContent = `${Vguess2[x]}`
        td.classList.add(result[x])
        tr.appendChild(td)
    }
    ...
    if(guesses == 6 && !gameOver){
        greenarray = new Array(5).fill("green")
        var tr = document.createElement("tr")
        table.appendChild(tr)
        for (var x = 0; x < 5; x++) {
            var td = document.createElement("td")
            td.textContent = `${answer.toUpperCase()[x]}`
            td.classList.add(greenarray[x])
            tr.appendChild(td)
        }
        grid.appendChild(table)
    ...
    console.log("GREEN ARRAY" , {greenLetter})
    console.log("YELLOW ARRAY" , {yellowLetter})
    console.log("GREY ARRAY ", {greyLetter})        

    let alphabetIndex2 = 0
    let tdElements = document.querySelectorAll(".AlphC")
    tdElements.forEach((td, alphabetIndex2) => {
    let letter = alphabet[alphabetIndex2] 
    if (greenLetter.includes(letter)) {
        td.classList.add("green")
        td.classList.remove("yellow")
        td.classList.remove("grey")

    } else if (yellowLetter.includes(letter)) {
        td.classList.add("yellow")
        td.classList.remove("grey")
        
    } else if (greyLetter.includes(letter)) {
